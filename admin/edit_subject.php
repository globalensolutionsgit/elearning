						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = mysql_query("select * from subject LEFT JOIN class ON class.class_id = subject.class_id where subject_id = '$get_id'")or die(mysql_error());
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" value="<?php echo $row['acedemic_year']; ?>" name="a_year" id="inputEmail" placeholder="Subject Code">
											</div>
										</div>
                                        <div class="control-group">
											<label class="control-label" for="inputEmail">Allowed Student</label>
											<div class="controls">
											<input type="text" value="<?php echo $row['allowed_student']; ?>" name="a_year" id="inputEmail" placeholder="Subject Code">
											</div>
										</div>
										<div class="control-group">
										...
										mysql_query("update subject set subject_code = '$s_code' ,
																		subject_title = '$title',
																		short_description = '$s_description',
																		long_description = '$l_description',
																		class_id = '$class_id',
																		status = '$status',
																		acedemic_year = '$a_year'
